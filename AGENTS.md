...
- **Code Location**: Before looking up, searching, or modifying any Go code, agents MUST first read `CODE_INDEX.md` to quickly locate the relevant files, symbols, and package structure for the code being worked on.
